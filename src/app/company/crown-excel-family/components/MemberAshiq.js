...
export default function MemberAshiq({ name, position, tenure, dept, quote, image }) {
  const displayName = name || "Mohammad Ashik Rehaman";
  const displayPosition = position || "Shop Assistant";
  ...
  const displayImage = image || Ashiq;
  return (
