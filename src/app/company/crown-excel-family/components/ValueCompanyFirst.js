...
export default function ValueCompanyFirst() {
  return (
    <div className="bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 flex flex-col items-center justify-center px-8 py-10 border border-[#e5e7eb]" style={{ minHeight: '260px' }}>
      ...
      <div className="flex flex-col items-center text-center">
        ...
        <p className="text-gray-500 font-muli text-base leading-relaxed mb-2">Treating every team member and customer as part of our extended family.</p>
      </div>
    </div>
  );
}
