        ...
        <div>
            ...
            <div className="container  w-full flex flex-col lg:flex-row items-center  justify-center gap-8 " style={{ paddingBottom: '10px'}}>
                <div className="left-part text-black w-full lg:w-2/5 mb-8 lg:mb-0">
                    <h2 className="font-semibold font-roboto  text-[58px] sm:text-5xl lg:text-5xl leading-[58px] text-center lg:text-left">Trusted <a href="https://www.grabatoz.ae/ae-en">Partner</a>  for <a href="https://www.grabatoz.ae/ae-en" target="_blank" rel="noopener noreferrer">Tech</a> Solutions</h2>
