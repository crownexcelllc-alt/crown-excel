...
const AllInOne = () => {
    return (
        <div className='mt-10'>
            <h1 className='bg-[#ffd900] font-[700] flex items-center justify-center w-full h-[90px] text-center text-black text-[50px] font-montserrat uppercase'>Popular all-in-one solutions</h1>
            <div className="for- mt-10">
                <div className="text-button flex items-center justify-between px-20 py-7">
                    <h1 className='text-[#147d61] text-[50px] font-[600]'>For Businesses:</h1>
                    <button className='p-[10px] bg-[#147d61] text-white flex items-center justify-center text-[20px] font-[500] w-[166px] h-[40px] rounded-[10px]'>Visit Our Store</button>
                </div>
                <div className="products flex items-center justify-between px-20 py-7" style={{
                    background: 'linear-gradient(to left, #000000 0%, #1a1a1a 50%, #2b2b2b 100%)'
                }}
                >
                    {Business.map((item, i) => (
                        <div className="product-item flex flex-col items-center   w-[285px] h-[297px]" key={i}>
            ...
            <div className="for- mt-10">
                <div className="text-button flex items-center justify-between px-20 py-7">
                    <h1 className='text-[#147d61] text-[50px] font-[600]'>For Individuals:</h1>
                    <button className='p-[10px] bg-[#147d61] text-white flex items-center justify-center text-[20px] font-[500] w-[166px] h-[40px] rounded-[10px]'>Visit Our Store</button>
                </div>
                <div className="products flex items-center justify-between px-20 py-7" style={{
                    background: 'linear-gradient(to left, #000000 0%, #1a1a1a 50%, #2b2b2b 100%)'
