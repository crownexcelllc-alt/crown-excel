...
" style={{
        ...
        <p className='text-[14px] lg:text-[16px] leading-[27px] font-montserrat mt-5'>HP Omen laptops are crafted to deliver exceptional gaming performance on the go. Equipped with the latest powerful processors, advanced NVIDIA GeForce RTX or AMD Radeon graphics, and high-refresh-rate displays, these laptops provide an immersive and fluid gaming experience. With customizable RGB lighting, efficient cooling systems, and a sleek durable design, HP Omen Laptops are built to handle even the most demanding games, offering ultimate portability and power in one package.</p>
