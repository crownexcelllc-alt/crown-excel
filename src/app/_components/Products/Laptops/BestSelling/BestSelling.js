...
const carouselData = [
    {
        ...
        description: `Experience Unmatched quality and reliablity with our premium hardware solutions and expert AMC services.`,
        image: BestProduct1,
    },
    {
        title: 'Acer Aspire 3 A315 Laptop Intel Core i3',
        description: 'Reliable and budget-friendly laptop designed for everyday computing needs.',
        image: BestProduct2,
    },
    {
        title: 'Acer Aspire 5 A515 Intel',
        description: 'Exceptional performance and sleek style in one package.',
        image: BestProduct3,
    },
]
...
const BestSelling = () => {
    ...
    return (
        <div className="w-full py-8 relative">
                    ...
                    >
                        {extendedSlides.map((item, idx) => (
                            ...
                            >
                                ...
                                <div className="flex basis-[60%] justify-center mt-6 ml-2 md:mt-0  md:-mr-15">
                                    <Image
                                        src={item.image}
                                        alt={item.title}
                                        width={454}
            ...
            <div className="yellow-div absolute bg-[#ffd900] -z-10 h-[550px] w-[600px] top-40 right-0 hidden md:block" style={{ borderRadius: '360px 0 0 360px' }}></div>
        </div>
    )
}
