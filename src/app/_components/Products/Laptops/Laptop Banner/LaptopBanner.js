    ...
    <div >
      ...
      >
        ...
        <div className="laptop-banner-left flex-1 flex justify-start items-end">
          <Image src={LaptopImage1} width={350} height={420} alt="Laptop 1" className="object-contain drop-shadow-2xl md:-mb-8" />
        </div>
        {/* Center Content */}
        <div className="laptop-banner-center z-10 absolute left-50 right-50 flex-1 flex flex-col items-center justify-center text-center px-2 md:px-8">
          ...
          <div className="text flex flex-col items-center mb-4">
            ...
            <h1 className='text-[60px] font-montserrat font-[900] text-[#147d61]'>LAPTOPS BRANDS</h1>
        ...
        <div className="laptop-banner-right flex-1 flex justify-end items-end">
          <Image src={LaptopImage2} width={380} height={450} alt="Laptop 2" className="object-contain drop-shadow-2xl -mb-4 md:-mb-8" />
        </div>
      </div>
      <div className="small-screen flex flex-col items-center justify-center lg:hidden h-[600px] w-full" style={{
        ...
        <div className="bottom flex mt-10 gap-3">
          <Image alt='' src={LaptopImage1} width={200} height={100}/>
          <Image alt='' src={LaptopImage2} width={200} height={100}/>
        </div>
      </div>
    </div>
  )
