...
const Performance = () => {
  return (
    <div
      className="w-full h-auto lg:h-[600px] mt-10 "
      style={{
    ...
    >
      <h1 className='text-center text-[30px] lg:text-[42px] leading-[40px] lg:leading-[55px] text-black font-[700] '>POWER, PORTABILITY AND <br className='lg:block hidden'/> <span className='bg-[#ffd900] text-[#147d61]'>PERFOR</span>MANCE IN ONE <span className='bg-[#ffd900]'>LAPTOP</span></h1>
      <div className="texts-area flex flex-col items-center justify-center gap-10 mt-20">
        <div className="top-texts flex flex-col lg:flex-row gap-5 lg:gap-0  items-center justify-between w-full">
          <div className="text-area-1 text-center bg-[#f1f1f1] rounded-[20px] text-black w-full lg:w-[582px] lg:h-[175px] flex flex-col " style={{ padding: '24px 40px 24px 40px', }}>
