...
const UnleashPower = () => {
  return (
    <div className='  flex relative items-center  mt-0 lg:mt-10 justify-between h-[450px] lg:h-[750px] w-full px-10'>
      <div className="unleash-left absolute left-0 lg:left-10  lg:-top-10">
        <Image alt='' width={250} height={100} src={GreenPart} className='w-[80px] md:w-[175px] lg:w-[250px] '/>
      </div>
      <div className="unleash-center  flex flex-col h-full w-full items-center justify-center z-10">
        ...
        <div className="image mt-5 md:my-20 lg:mt-0">
            <Image alt='' height={513} width={912} src={Laptop} className='lg:w-[912px] lg:h-[513px] md:w-[600px] w-[300px]'/>
        </div>
      </div>
