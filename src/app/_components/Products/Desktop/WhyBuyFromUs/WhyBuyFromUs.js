...
const WhyBuyFromUs = () => {
  return (
    <div className='why-buy-from-us flex flex-col lg:flex-row lg:flex items-center gap-5 lg:gap-40 w-full h-auto lg:h-[700px] mt-20'>
      <div className="left-part w-full h-auto lg:w-[518px] lg:h-[700px] bg-[#ffd900]">
        <Image alt='' src={YelloBckground} width={518} height={300}/>
        <div className="text-part w-full h-full  -mt-5 lg:mt-0 px-10 pt-0 pb-8 lg:pt-[120px] lg:pr-[82px] lg:pb-[82px] lg:pl-[82px] ">
            <h1 className='text-[30px] leading-[30px] lg:text-[50px] w-[250px] lg:w-[354px] font-[600] lg:leading-[60px] text-black font-montserrat'>Why Buy <span className='text-[#118264]'>Desktops</span> From <br /> Us?</h1>
