...
const DesktopBanner = () => {
  return (
    <div >
      <div
        className="hidden lg:flex items-center justify-between w-full h-[180px] lg:h-[500px] md:h-[350px] px-3 md:px-10 relative"
        style={{
      ...
      >
        ...
        <div className="laptop-banner-left flex-1 flex justify-start items-end">
          <Image src={DesktopImage1} width={250} height={200} alt="Laptop 1" className="object-contain drop-shadow-2xl md:-mb-8" />
        </div>
        {/* Center Content */}
        <div className="laptop-banner-center z-10 absolute left-50 right-50 flex-1 flex flex-col items-center justify-center text-center px-2 md:px-8">
          ...
          <div className="text flex flex-col items-center mb-4">
            ...
            <h1 className='text-[60px] font-montserrat font-[900] text-[#147d61]'>DESKTOP BRANDS</h1>
        ...
        <div className="laptop-banner-right flex-1 flex justify-end items-end">
          <Image src={DesktopImage2} width={250} height={200} alt="Laptop 2" className="object-contain drop-shadow-2xl -mb-4 md:-mb-8" />
        </div>
      </div>
      <div className="small-screen flex flex-col gap-20 py-20 items-center justify-center lg:hidden h-auto w-full" style={{
        background: 'linear-gradient(87deg, #2D2D2D 35%, #147D61 100%)',
      }}>
