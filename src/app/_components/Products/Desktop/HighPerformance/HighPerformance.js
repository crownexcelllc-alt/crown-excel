...
const HighPerformance = () => {
  return (
    <div className='flex lg:flex-row flex-col items-center  w-full h-auto px-5 mt-20'>
      ...
      <div className="highperformance-right basis-[40%] flex flex-col lg:mt-o mt-5">
        <h1 className='text-[30px] leading-[30px] lg:text-[44px] font-[700] font-montserrat lg:leading-[52px] text-black'>HIGH-PERFORMANCE DESKTOP FOR CREATIVE PROFESSIONAL</h1>
