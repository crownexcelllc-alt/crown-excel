...
const UnleasePowerDesktop = () => {
  return (
    <div className='flex flex-col items-center justify-center w-full h-auto px-5'>
      <div className="heading w-[full] h-auto lg:w-[1140px] lg:h-[150px] px-2 lg:px-10 flex items-center lg:justify-center" style={{backgroundImage: 'linear-gradient(126deg, #54595f 0%, #000000 100%)', borderRadius: '30px 0px 30px 0px', padding:'15px'}}>
        <h1 className='text-[14px] leading-[20px] lg:text-[48px] lg:leading-[60px] font-[700] font-montserrat px-5 lg:px-10 text-center'>UNLEASE POWER AND PERFORMANCE IN ONE DESKTOP SOLUTIONS</h1>
      </div>
      <div className="info flex lg:flex-row flex-col items-center  just-between w-full h-auto lg:h-[400px] mt-20" style={{borderRadius: '40px 0px 40px 0px'}}>
        <div className="info-left">
          <div className="heading px-5 py-2 rounded-[20px]" style={{background: 'linear-gradient(90deg, #ffd900 0%, #FFFFFF 31%)'}}>
            <h1 className='text-black text-[20px] leading-[25px] lg:text-[50px] font-[800] lg:leading-[65px] tracking-[2px]'>GET MORE WITH <br /> EFFICIENT DESKTOP SOLUTIONS</h1>
          </div>
