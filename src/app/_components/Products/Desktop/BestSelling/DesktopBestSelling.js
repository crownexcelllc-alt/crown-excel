...
const DesktopBestSelling = () => {
  ...
  <div className="w-full  overflow-x-hidden bg-white py-12">
    ...
    <div className="hidden md:flex items-center justify-center max-w-7xl mx-auto relative min-h-[500px] overflow-x-hidden">
      {/* Left Button */}
      <div className="absolute left-[-170px] top-1/2 -translate-y-1/2 z-20 w-[328px] h-[328px]">
        <Image
      ...
      {swiperReady && (
        ...
        >
          {carouselData.map((item, idx) => (
            <SwiperSlide key={idx}>
              <div className="flex flex-row items-center justify-center gap-4 min-h-[420px] transition-all duration-700 ease-in-out">
                {/* Product Image */}
      ...
      {/* Right Button */}
      <div className="absolute right-[-170px] top-1/2 -translate-y-1/2 z-20 w-[328px] h-[328px]">
        <Image
          src={ButtonBackground}
