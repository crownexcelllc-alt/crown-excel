...
const PerformancePrinters = () => {
  return (
    <div
      className="w-full h-[900px] lg:h-[700px] mt-10 "
      style={{
    ...
    >
      <h1 className='text-center text-[26px] lg:text-[42px] leading-[35px] lg:leading-[55px] text-black font-[700] '>POWER, PORTABILITY AND <br className='lg:block hidden'/> <span className='bg-[#ffd900] text-[#147d61]'>PERFOR</span>MANCE IN ONE <span className='bg-[#ffd900]'>PRINTER</span></h1>
      <div className="texts-area flex flex-col items-center justify-center gap-5 lg:gap-10 mt-10 lg:mt-20 px-3 lg:px-0">
        <div className="top-texts flex flex-col lg:flex-row gap-5 lg:gap-0  items-center justify-between w-full">
          <div className="text-area-1 bg-[#f1f1f1] rounded-[20px] text-black w-full lg:w-[582px] lg:h-[217px] flex flex-col items-center text-center px-2 py-[24px] lg:py-[24px] lg:px-[40px]">
          ...
          <div className="text-area-1 text-center bg-[#f1f1f1] rounded-[20px] text-black w-full lg:w-[582px] lg:h-[217px] flex flex-col px-2 py-[24px] lg:py-[24px] lg:px-[40px]" >
        ...
        <div className="bottom-te">
          <div className="text-area-1 text-center bg-[#f1f1f1] rounded-[20px] text-black w-full lg:w-[582px] lg:h-[189px] flex flex-col px-2 py-[24px] lg:py-[24px] lg:px-[40px]" >
